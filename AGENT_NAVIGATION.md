...
**iter 20+ — что осталось:**
- **iter 20+:** KI#13 (123 inline styles → external CSS classes) + Phase 4 actual SVG integration (заменить textual content на VS-EMBED где возможно) — после KI#16 closed (iter 19 done).
...
**Подсказка следующему агенту:** Перед стартом iter 20+ прочитай `STATUS.md` (iter 19 COMPLETE, KI#16 ✅ CLOSED, Canon COMPLETE iter 18, KI#13+KI#17 ACTIVE), `worklog.md` (iter 19 record), этот файл (AGENT_NAVIGATION §8 iter 20+ roadmap), `docs/canon/_README.md` (§5 migration status — все 10 Parts + 3 Appendix ✅, Canon COMPLETE), `docs/CONTENT_RESTRUCTURE_PLAN.md` (§5.2 iter 20 priorities). iter 20+ priorities: KI#13 (123 inline styles → external CSS classes) + Phase 4 actual SVG integration (заменить textual content на VS-EMBED где возможно) — см. `_README.md` §5. Принцип «viz > dry text» (iter 8) — сохраняется. Если найден новый баг — сначала документируй в `STATUS.md` как Known Issue, потом фиксий.
