...
**iter 26+ — что осталось:**
- **Все planned work (Canon migration iter 7–18, KI#13 fix iter 20–24, Phase 4 SVG iter 25) — DONE.** Iter 26+ roadmap — empty.
- **Все Known Issues (KI#1..KI#17) ✅ CLOSED.** Активных KI нет. Новые баги — сначала документировать в `STATUS.md` как Known Issue (KI#N), потом фиксить.
- **Возможные продолжения (необязательные, low priority):** (a) visual polish E18 standalone prototype в браузере, (b) UX audit других Parts на кандидаты для новых VS elements (low priority, не блокирует).
...
**Подсказка следующему агенту:** Перед стартом iter 26+ прочитай `STATUS.md` (iter 25 COMPLETE, Phase 4 SVG integration DONE, все KI#1..#17 ✅ CLOSED, active KI нет), `worklog.md` (iter 25 record), этот файл (AGENT_NAVIGATION §6 pitfall #36 KI#13 ✅ CLOSED, §8 iter 26+ roadmap — empty, все planned work DONE), `docs/canon/_README.md` (§5 migration status — все 10 Parts + 3 Appendix ✅, Canon COMPLETE), `docs/CONTENT_RESTRUCTURE_PLAN.md` (§5.2 iter 25 → ✅ DONE, §8 Phase 4 COMPLETE). Все planned work (Canon migration iter 7–18, KI#13 fix iter 20–24, Phase 4 SVG iter 25) — DONE. iter 26+ roadmap — empty. Возможные продолжения (необязательные, low priority): visual polish E18 в браузере, UX audit других Parts на кандидаты для новых VS elements. Принцип «viz > dry text» (iter 8) — сохраняется. Если найден новый баг — сначала документируй в `STATUS.md` как Known Issue, потом фиксий.
