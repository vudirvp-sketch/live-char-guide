#!/usr/bin/env node
// ⚠️ STANDALONE UTILITY: Not part of the main build pipeline.
// Use for manual manifest regeneration only.
// The main build uses build-layers.mjs for manifest generation.
//
// WARNING: This script uses a DIFFERENT HTML parsing strategy than build-layers.mjs:
//   - build-layers.mjs: extracts h2 text for section titles
//   - gen-manifest.mjs: extracts h3/h4 text for section titles
// If manifests generated by this script diverge from build-layers.mjs output,
// ALWAYS trust build-layers.mjs as the canonical source.
//
// TODO: Consider deprecating this script and merging its unique functionality
// (top-level manifest generation) into build-layers.mjs.
/**
