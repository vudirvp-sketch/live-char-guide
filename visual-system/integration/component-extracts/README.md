...
Извлечённые и очищенные компоненты из standalone HTML-прототипов,
готовые к встраиванию в сборку руководства.
...
Извлечённые файлы создаются по мере выполнения Phase 4 (интеграция).
См. INTEGRATION-MAP.md для полного списка планируемых файлов.
Часть файлов уже создана (например, E12-visual.html).
