...
**Voice Isolation** — правило разделения Voice (голос) и описания. **Лингвистический голос** (слова, синтаксис, ритм речи, лексика, парадоксы) задаётся ТОЛЬКО в Examples и Greeting, никогда в Description.
...
**RULE — Лингвистический паттерн vs физическая характеристика:** Различайте два уровня голоса персонажа:
...
- **Физическая характеристика голоса** (тембр, хрип, механический гул, синтезированный резонанс, сиплость, тихая/громкая подача) — **это часть Embodiment, допустимо в Description** (обычно в Embodiment-блоке внутри Description, рядом с постурой, мимикой, движениями). Это сенсорный слой Embodiment Protocol (см. Part 2: Embodiment, слой «СЕНСОР» — Звук).
...
**RULE:** Для 12B: Description = 0% влияния на лингвистический голос. Правило голоса: стилистические директивы в Description — ошибка сборки. Токены, потраченные на лингвистический голос в Description — потеряны или вредят. Физическая характеристика (тембр, хрип) — допустима в Description как часть Embodiment (см. RULE выше в §3.1).

**EXAMPLE — Лингвистический голос (только Examples) vs физическая характеристика (допустима в Description):**
...
Система оценки качества Examples по 6 критериям. Три критерия оценивают сами Examples, три — карточку в целом, но проявляются они через Examples. Качество оценивается по системе **Quality Grade** (класс A / B / C) (не путать с CoT Tier 0–3 из Part 6 или GHOST Layers Tier 1–3 из Part 10):
