...
migration_status: ✅ NEW (iter 38) — концептуальный reference, не имеет master HTML артефакта
---
...
| Персонаж | Где используется | Сложность | GHOST | SPINE | Enneagram | OCEAN экстремумы | CoT | Lorebook |
|----------|------------------|-----------|-------|-------|-----------|-------------------|-----|----------|
