...
- **ANCHORS — Базовые + FLAW-linked** в `<anchors>` XML: T→A→P формат, FLAW-linked Anchors (Гордость задета → челюсть сжимается → пальцы барабанят) — см. Part 2 §2.X и Part 4 §4.8.
...
- **ANCHORS — Базовые + FLAW-linked + Зеркало-linked + Sensory Anchors:** 4 типа Anchors в `<anchors>` XML; Sensory Anchors (Тактильный/Обонятельный) — расширение базового T→A→P — см. Part 2 §2.X и Part 4 §4.8.
