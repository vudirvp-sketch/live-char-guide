...
| AP-16 | Nested Anchors | p8_ap16_nested_anchors | Средняя |
...
|------|-------------|---------|
| 124-139 | AP-1 through AP-16 | Full content ownership table for all 16 APs |
...
| 123 | AP-1 through AP-16 | Sequential ordering note |
...
| Line (approx) | AP Reference | Context |
|---------------|-------------|---------|
| 285 | AP-1 through AP-16 | Catalog reference |
...
When AP-15 is moved from Part 8 to Part 5 (Phase 2.2), and AP-16 is renumbered to AP-15:
- **Renumbering cascade:** AP-16 → AP-15
