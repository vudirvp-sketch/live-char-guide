...
| 2 | p7_system_prompt | p7_core_directives | Internal href `#p7_core_directives` | ✅ p7_core_directives referenced as sub-section |
| 3 | p7_system_prompt | p7_tone_frame | Internal href `#p7_tone_frame` | ✅ p7_tone_frame is sub-section of p7 |
| 4 | p7_lorebook | p7_lorebook_mechanics | `href="#p7_lorebook_mechanics"` | ✅ p7_lorebook_mechanics references p7_lorebook via callout link |
| 5 | p7_authors_note | p7_lorebook_mechanics | `href="#p7_lorebook_mechanics"` | ✅ p7_lorebook_mechanics does not reference back — acceptable (AN is upstream) |
| 6 | p7_lorebook_advanced | p7_authors_note | `href="#p7_authors_note"` in Кросс-ссылки section | ✅ p7_authors_note references p7_lorebook_mechanics via upstream link |
| 7 | p7_lorebook_advanced | p7_structured_inject | `href="#p7_structured_inject"` in Кросс-ссылки section | ✅ Forward link only — p7_structured_inject is technique reference (acceptable) |
| 8 | p4_spine_navigation | p7_xml_tags | Pipeline step 3 via href | ✅ p7_xml_tags is downstream |
