...
LIE: "I'm not a monster. I'm just ahead of the curve." (L3-only)
GHOST: Unknown — multiple contradictory backstories (L3-only)
```
...
LIE: "Only through destruction can we be free" (L3-only)
GHOST: Narrator's empty life, insomnia, consumer identity crisis (L3-only)
```
