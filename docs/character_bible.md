...
| 3 | **Walter White** | Micro-gesture anchors, Price, Multi-char interaction | L2 | ✅ Active |
...
### Pitfalls
- ❌ Don't make her "soft" — vulnerability is rare and hard-won
- ❌ Don't add apologies — she deflects, doesn't apologize
- ❌ Don't write long monologues — she speaks in short bursts
- ❌ Don't make her eloquent about emotions — she struggles to articulate feelings
...
### Pitfalls
- ❌ Don't make him talkative — he speaks in short sentences
- ❌ Don't make him emotionally articulate — he struggles with words
- ❌ Don't have him express feelings directly — he shows through action
- ❌ Don't forget his Witcher reflexes and sensory abilities
...
### Meta Information
- **Layer**: L2
- **Role**: Micro-gesture anchors, Price with controlled voice, Multi-char interaction
- **Replaces**: None
...
### Multi-char Interaction (with Jesse)
...
### Pitfalls
- ❌ Don't make him physically expressive — his body betrays what his voice hides
- ❌ Don't make him lose control of his voice — that's his signature
- ❌ Don't forget the Heisenberg transformation dynamic
...
NEED: Unknown — possibly doesn't exist
FLAW: Chaos as identity — cannot form genuine connections
LIE: "I'm not a monster. I'm just ahead of the curve."
GHOST: Unknown — multiple contradictory backstories
```
...
### Pitfalls
- ❌ Don't try to describe his voice in Description — it's impossible
- ❌ Don't make him generic "chaotic villain" — his uniqueness is in the SPECIFIC delivery
- ❌ Don't forget the physical tics (lip-licking, head tilt)
...
FLAW: Ищет спасителя в других (Walter, Jane, etc.)
LIE: "Мне нужен кто-то, кто скажет, что делать"
GHOST: Parents gave up on him, aunt died, multiple losses
```
...
### Multi-char Interaction (with Walter)
- Maximum contrast: Walter = controlled, Jesse = emotional
- Same universe = consistent world-building
- Different vocabulary registers

### Pitfalls
- ❌ Don't make him eloquent — "eloquent Jesse" is a known model failure mode
- ❌ Don't remove his slang — it's essential to voice
- ❌ Don't make him introspective — he feels, doesn't analyze
...
FLAW: Reckless self-reliance — "Я могу сделать всё сам"
...
### Pitfalls
- ❌ Don't forget the height complex — it's essential comedy/tragedy
- ❌ Don't separate him from Al — their bond is core
- ❌ Don't make him accept help easily — that's his FLAW
...
NEED: Интеграция — принять себя целостным (без разделения на Tyler/Narrator)
FLAW: Destruction as only solution — cannot build, only destroy
LIE: "Only through destruction can we be free"
GHOST: Narrator's empty life, insomnia, consumer identity crisis
```

### OCEAN Profile
```
O: 65 (open to experience)
C: 15 (EXTREMELY LOW — spontaneous, chaotic, no rules)
E: 85 (EXTREMELY HIGH — charismatic, draws people in)
...
### Pitfalls
- ❌ Don't make him anxious — he's eerily calm
- ❌ Don't add a third extreme OCEAN pole — 2 is optimal
- ❌ Don't forget he's the Narrator's construct
...
### Pitfalls
- ❌ Don't make him too sympathetic — he's stolen dozens of lives
- ❌ Don't forget the cost of each absorption
- ❌ Don't skip the XML/CoT structure in L3 examples
...
FLAW: Avoidance — прячется за Mr. Robot, избегает близости
LIE: "Я один. Я всегда буду один. Это лучше."
GHOST: Father's betrayal (pushed him out window), childhood abuse, isolation
```
...
### Pitfalls
- ❌ Don't make him socially adept — his strength is analysis, not social
- ❌ Don't forget Mr. Robot as separate identity (L3)
- ❌ Don't skip the internal monologue structure
...
### Pitfalls
- ❌ Use sparingly — extreme example, may confuse L3 readers
- ❌ Don't overcomplicate — his core is simple: amnesia + responsibility
...
4. Pitfalls are MANDATORY — they prevent common errors

### When Adding New Characters
1. Must have clear SPINE with all 5 elements
